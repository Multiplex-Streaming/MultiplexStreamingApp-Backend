...
namespace Multiplex.Domain.Contexts.AutoGenerated
{
    public partial class MultiplexContext : DbContext
    {
        ...
        public virtual DbSet<UsuariosPagos> UsuarioPagos { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CapituloSerie>(entity =>
            {
                ...
                entity.Property(e => e.TemporadaCp)
                    .HasColumnName("TEMPORADA_CP")
                    .HasMaxLength(100)
                    .IsUnicode(false);
            ...
            modelBuilder.Entity<Series>(entity =>
            {
                ...
                entity.Property(e => e.PortadaSr)
                    .HasColumnName("PORTADA_SR")
                    .HasMaxLength(100)
                    .IsUnicode(false);

                entity.Property(e => e.UrlSr)
                    .HasColumnName("URL_SR")
                    .HasMaxLength(100)
                    .IsUnicode(false);
            });
            ...
            modelBuilder.Entity<Pagos>(entity =>
            {
                ...
                entity.Property(e => e.IsPagado).HasColumnName("ISPAGADO");
            ...
            modelBuilder.Entity<UsuariosPagos>(entity =>
            {
                entity.HasKey(e => new { e.IdUsr, e.IdPago })
                    .HasName("PK_USUARIOS_PAGOS");

                entity.ToTable("USUARIOS_PAGOS");
                ...
                entity.HasOne(d => d.Usuario)
                    .WithMany(p => p.UsuariosPagos)
                    .HasForeignKey(d => d.IdUsr)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_USUARIOS_PAGOS_USUARIOS");

                entity.HasOne(d => d.Pago)
                    .WithMany(p => p.UsuariosPagos)
                    .HasForeignKey(d => d.IdPago)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_USUARIOS_PAGOS_PAGOS");
            });
