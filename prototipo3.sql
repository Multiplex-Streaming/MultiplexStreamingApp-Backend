...
CREATE TABLE HISTORIAL_PELICULAS (
    ...
    MINUTOS SMALLINT, -- Ajusta el tipo de datos según tus necesidades
    SEGUNDOS SMALLINT, -- Ajusta el tipo de datos según tus necesidades
...
CREATE TABLE USUARIOS_PAGOS (
    ...
    PRIMARY KEY (ID_USR, ID_PAGO)
);

CREATE UNIQUE INDEX USUARIOS_PAGOS_PK ON USUARIOS_PAGOS (ID_USR ASC, ID_PAGO ASC);

-- Restricciones FOREIGN KEY para las relaciones
ALTER TABLE USUARIOS_PAGOS
ADD FOREIGN KEY (ID_USR) REFERENCES USUARIOS (ID_USR);
